        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'restaurant/index';?>">Agences</a>
                    </li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="<?php echo base_url().'profile';?>"><i
                                    class="fas fa-user-circle"></i> Mon compte</a>
                            <hr>
                    ...
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url().'cart';?>"><i class="fas fa-cart-arrow-down"></i> pannier</a>
                    </li>
                    <?php } ?>
                </ul>
            </div>
