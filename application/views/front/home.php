<div id="slides" class="carousel slide carousel-cus" data-ride="carousel">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="<?php echo base_url().'public/front/img/bfbrg.png';?>" alt="FriesBrgrImg">
            <div class="carousel-caption text-left">
                <h1 class="display-2">City car </h1>
                <h3>prés de vous partout au maroc</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Reservez maint</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">notre menu</a>
            </div>
        </div>
        <div class="carousel-item">
        <img src="<?php echo base_url().'public/front/img/bckg.jpg';?>" alt="FriesBrgrImg">
            <div class="carousel-caption text-right">
                <h1 class="display-2">City car</h1>
                <h3>12 agences dans 7 villes et aeroports</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Reservez maint</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">Notre Menu</a>
            </div>
        </div>
        <div class="carousel-item">
            <img src="<?php echo base_url().'public/front/img/snwbg.png';?>" alt="corn">
            <div class="carousel-caption text-right">
                <h1 class="display-2">City car</h1>
                <h3>24/24 7/7 les meilleirs services vos attendent</h3>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-outline-light btn-lg">Reservez maint</a>
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">Notre Menu</a>
            </div>
        </div>
